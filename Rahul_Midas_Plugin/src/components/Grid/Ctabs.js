  ...
  return (
    <Box sx={{ width: '100%' ,ml:0}}>
      ...
      <TabPanel value={value} index={0}>
                    <Typography sx={{ color:"grey",  fontFamily:"serif" ,component:"div",  ml:25,mt:0,font:'caption'}}  >
                           Number
                    </Typography>  
                    <Typography sx={{ color:"grey",  fontFamily:"serif" ,component:"div",  ml:65,mt:-2.5,font:'caption'}}  >
                           Coordinates
                    </Typography> 

                    <Typography sx={{ color:"grey",  fontFamily:"serif" ,component:"div",  ml:-90,mt:5,font:'caption'}}  >
                            Start Node
                    </Typography>    
                    <Typography sx={{ color:"grey",  fontFamily:"serif" ,component:"div",  ml:-90,mt:5,font:'caption'}}  >
                            End Node
      ...
      <TabPanel value={value} index={1}>
                    <Typography sx={{ color:"grey",  fontFamily:"serif" ,component:"div",  ml:-70,mt:7,font:'caption'}}  >
                            Start Node Number
                    </Typography>    
                    <Typography sx={{ color:"grey",  fontFamily:"serif" ,component:"div",  ml:-70,mt:5,font:'caption'}}  >
                            End Node Number
                    </Typography> 
